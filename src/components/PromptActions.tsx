...
export default function PromptActions({ promptId, locale }: Props) {
  ...
  return (
    <div className="flex gap-2 ml-auto">
      <Link
        ...
        className="flex items-center gap-2 rounded-xl border border-line bg-ink/5 px-4 py-2 text-sm font-medium text-zinc-300 transition-all hover:border-brand/30 hover:bg-brand/10 hover:text-brand"
      >
      ...
      {!showDeleteConfirm ? (
        ...
        <div className="flex gap-2">
          <button
            ...
            className="rounded-xl border border-line bg-ink/5 px-3 py-2 text-sm font-medium text-zinc-300 transition-all hover:bg-ink/10 hover:text-fg"
            disabled={deleting}
          >
            {t("cancel")}
          </button>
