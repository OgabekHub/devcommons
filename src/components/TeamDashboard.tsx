...
export default function TeamDashboard() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto mt-12 bg-black/40 border border-white/10 rounded-2xl overflow-hidden shadow-2xl backdrop-blur-xl">
      {/* Dashboard Header */}
      <div className="border-b border-white/10 p-6 md:p-8 bg-gradient-to-r from-[#0F172A] to-transparent">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="flex items-center justify-center h-16 w-16 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 shadow-lg border border-white/20">
          ...
          <button className="hidden md:flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-sm font-medium text-white transition-colors">
      ...
      <div className="p-6 md:p-8 min-h-[400px]">
        {activeTab === "rules" && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-lg font-semibold text-white">{t("rule_card_title")}</h3>
                <p className="text-sm text-gray-400">{t("rule_card_desc")}</p>
              </div>
            ...
            {/* Mock Private Rule 1 */}
            <div className="group flex items-center justify-between p-4 rounded-xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-colors">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-sm font-medium text-white">Enterprise React Architecture</h4>
                  <div className="flex items-center gap-2 mt-1">
                    <span className="text-xs text-gray-500">Target: .cursorrules</span>
            ...
            <div className="group flex items-center justify-between p-4 rounded-xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-colors">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-sm font-medium text-white">Acme AWS CDK Deploy Protocol</h4>
                  <div className="flex items-center gap-2 mt-1">
                    <span className="text-xs text-gray-500">Target: CLAUDE.md</span>
                    <span className="w-1 h-1 rounded-full bg-gray-600"></span>
        ...
        {activeTab === "settings" && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 text-center py-16">
            ...
            <h3 className="text-lg font-medium text-gray-300">Workspace Settings</h3>
            <p className="text-sm text-gray-500 mt-2 max-w-md mx-auto">Only workspace owners can configure billing, API limits, and GitHub sync integrations.</p>
          </div>
        )}
      </div>
    </div>
