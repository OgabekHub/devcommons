...
export default function ForkButton({ itemId, itemType, title, content, languageOrCategory }: Props) {
  ...
  return (
    <button
      onClick={handleFork}
      disabled={forking}
      className="flex items-center gap-2 rounded-lg px-3 py-1.5 text-sm font-medium text-blue-400 transition-colors duration-200 hover:bg-blue-500/20 hover:text-blue-300 bg-blue-500/10 border border-blue-500/30 shadow-[0_0_12px_rgba(59,130,246,0.15)] disabled:opacity-50"
