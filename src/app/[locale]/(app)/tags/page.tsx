    ...
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      {tags.length === 0 ? (
        <div className="card border-dashed border-line p-10 text-center">
          <Hash className="mx-auto mb-3 h-8 w-8 text-zinc-500" />
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <div className="text-right">
                  <span className="text-2xl font-bold text-fg">{tag.total_count}</span>
                  <p className="text-xs text-zinc-400">{t("total")}</p>
                </div>
              </div>
            </Link>
          ))}
