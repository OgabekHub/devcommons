  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 animate-fadeIn pb-24">
      ...
      <div className="mb-10 text-center">
        ...
        <h1 className="text-3xl md:text-4xl font-extrabold text-fg tracking-tight mb-3">
          {t("title")}
        </h1>
      ...
      {/* Intro Section */}
      <section className="bg-ink/5 border border-line rounded-2xl p-6 md:p-8 mb-8 backdrop-blur-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        {/* Snippets */}
        <div className="card hover:border-brand/30 transition-colors group">
          ...
          <h3 className="text-lg font-bold text-fg mb-2">{t("feat_snippets_title")}</h3>
        ...
        <div className="card hover:border-brand/30 transition-colors group">
          ...
          <h3 className="text-lg font-bold text-fg mb-2">{t("feat_prompts_title")}</h3>
          <p className="text-sm text-zinc-400 mb-4 line-clamp-3">
            {t("feat_prompts_desc")}
          </p>
        ...
        <div className="card hover:border-brand/30 transition-colors group">
          ...
          <h3 className="text-lg font-bold text-fg mb-2">{t("feat_teams_title")}</h3>
          <p className="text-sm text-zinc-400 mb-4 line-clamp-3">
            {t("feat_teams_desc")}
          </p>
        ...
        <div className="card hover:border-brand/30 transition-colors group">
          ...
          <h3 className="text-lg font-bold text-fg mb-2">{t("feat_cli_title")}</h3>
          <p className="text-sm text-zinc-400 mb-4 line-clamp-3">
            {t("feat_cli_desc")}
          </p>
      ...
      <div className="bg-gradient-to-br from-brand/20 via-brand/5 to-transparent border border-brand/20 rounded-2xl p-8 text-center">
        <h2 className="text-2xl font-bold text-fg mb-3">{t("ready_title")}</h2>
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <Link
            href="/feed"
            className="rounded-lg bg-ink/5 border border-line px-6 py-2.5 text-sm font-semibold text-fg hover:bg-ink/10 transition-colors"
          >
            {t("explore_feed")}
          </Link>
        </div>
