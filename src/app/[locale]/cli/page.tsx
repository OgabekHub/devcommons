  ...
  return (
    <div className="container mx-auto max-w-[1380px] px-4 py-12 pb-24 sm:px-6 lg:px-8">
      ...
      <div className="mb-14 text-center">
        ...
        {/* Feature Pill Row */}
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4 text-xs font-semibold text-gray-300">
          <span className="flex items-center gap-1.5 rounded-xl bg-white/5 px-3 py-2 border border-white/10">
      ...
      <div className="mt-16 grid gap-8 md:grid-cols-3">
        <div className="rounded-3xl border border-white/10 bg-gradient-to-b from-[#0A0D16] to-[#07090E] p-7 shadow-xl hover:border-cyan-500/40 transition">
          ...
          <h3 className="text-xl font-bold text-white">{t("card_cli_title")}</h3>
          <p className="mt-2 text-xs sm:text-sm text-gray-400 leading-relaxed">
            {t("card_cli_desc")}
          </p>
          <div className="mt-5 font-mono text-xs text-cyan-300 bg-white/5 p-3 rounded-xl border border-white/5">
            $ npx -y @devcommons/cli pull clean-arch
          </div>
        </div>

        <div className="rounded-3xl border border-white/10 bg-gradient-to-b from-[#0A0D16] to-[#07090E] p-7 shadow-xl hover:border-purple-500/40 transition">
          ...
          <h3 className="text-xl font-bold text-white">{t("card_ide_title")}</h3>
          <p className="mt-2 text-xs sm:text-sm text-gray-400 leading-relaxed">
            {t("card_ide_desc")}
          </p>
          <div className="mt-5 flex items-center justify-between text-xs text-purple-300 font-bold bg-white/5 p-3 rounded-xl border border-white/5">
            <span>VS Code / Cursor Extension</span>
            <ArrowRight className="h-4 w-4" />
          </div>
        </div>

        <div className="rounded-3xl border border-white/10 bg-gradient-to-b from-[#0A0D16] to-[#07090E] p-7 shadow-xl hover:border-emerald-500/40 transition">
          ...
          <h3 className="text-xl font-bold text-white">{t("card_mcp_title")}</h3>
          <p className="mt-2 text-xs sm:text-sm text-gray-400 leading-relaxed">
            {t("card_mcp_desc")}
          </p>
          <div className="mt-5 font-mono text-[11px] text-emerald-300 bg-white/5 p-3 rounded-xl border border-white/5 truncate">
