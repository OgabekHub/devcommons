...
export default function EditPromptPage({ params: { id, locale } }: Props) {
  ...
  useEffect(() => {
    const loadPrompt = async () => {
      ...
      setAiModel(prompt.ai_model || "Any");
      setTags((prompt.tags as string[]) || []);
      setFetching(false);
    };
    ...
    <div className="mx-auto max-w-3xl px-4 py-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-3 pt-2">
          <Link href={`/prompts/${id}`} className="btn-secondary flex-1 py-3 text-center">
            {t("btn_cancel")}
          </Link>
          <button
            type="submit"
