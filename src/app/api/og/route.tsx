      ...
      (
        <div
          style={{
            ...
            backgroundImage: "radial-gradient(circle at 80% 20%, rgba(107,78,255, 0.25) 0%, transparent 50%), radial-gradient(circle at 20% 80%, rgba(59, 130, 246, 0.2) 0%, transparent 50%)",
            padding: "60px",
